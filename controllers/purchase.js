...
const purchases = async (req, res = response) => {
  try {
...
const purchaseByID = async (req, res = response) => {
  const { id } = req.params
  try {
...
const completePurchase = async (req, res = response) => {
  try {
...
const purchaseFromConversation = async (req, res = response) => {
...
const purchaseConversarionByID = async (req, res = response) => {
  const { id } = req.params
  try {
    if (id) {
