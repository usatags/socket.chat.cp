...
INSERT INTO "new_Purchase" ("color", "continuePurchase", "conversation_id", "details", "email", "id", "state", "user_id", "vin") SELECT "color", "continuePurchase", "conversation_id", "details", "email", "id", "state", "user_id", "vin" FROM "Purchase";
DROP TABLE "Purchase";
