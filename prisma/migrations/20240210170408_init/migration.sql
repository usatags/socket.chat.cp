...
INSERT INTO "new_Purchase" ("color", "completed", "continuePurchase", "conversation_id", "details", "email", "id", "options", "state", "user_id", "vin") SELECT "color", "completed", "continuePurchase", "conversation_id", "details", "email", "id", "options", "state", "user_id", "vin" FROM "Purchase";
DROP TABLE "Purchase";
